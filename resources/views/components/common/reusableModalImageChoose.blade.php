{{--
     <x-common.reusableModalChoose modalTitle="hello Modal" modalId="this-is-id"
        ...
        rootDiv="rootDiv" :selectItems="$operators" selectName="name" selectImage="image"/>
    --}}
                     ...
                     focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600
                      ...
                      dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        @if ($attributes['object'] != '')
                            @foreach ($attributes['object'] as $item)
                                <div class="grid gap-2 md:grid-cols-3 xl:grid-cols-3 bg-white
                                 rounded-lg shadow-lg place-content-center place-items-center mainDialog"
                                    id="">
                                    <input type="hidden" value="{{ $item->id }}" class="styleId">
                                    <div class="px-4 py-3 mb-2 mt-2">
                                        <img class="object-cover w-20 rounded-lg h-96 md:h-auto md:w-24" id=""
                                            src="{{ isset($item->selectImage) ? $item->selectImage : '' }}" alt="">
                                    </div>
                                    <div class="styleName px-4 py-3" id="">
